...
<%@include file="header.jsp"%>
    <div style="width: 70%; margin: 50px auto; font-size: 18px ">
        <div style="text-align: center;"><img src="https://m.ticketon.kz/images/logo.png" alt="тикетон" style="margin:20px 0px"></div>
        <p>
        ...
        <div style="text-align: center;"><img src="https://ticketon.kz/files/images/Online%20ClassRegistration%20(8).png" alt="тикетон" style="vertical-align:middle;margin:10px 0px"></div>
    </div>
</body>
</html>
